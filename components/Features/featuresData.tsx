...
const featuresData: Feature[] = [
  ...
  },
  {
    ...
    icon: (
      <Image
        src="/images/products/Tem/4.png" // Replace with the correct path to your SVG file
        alt="description of the image"
        width={250}
        height={250}
      />
  ...
  },
  {
    ...
    icon: (
      <Image
        src="/images/products/Tem/5.png" // Replace with the correct path to your SVG file
        alt="description of the image"
        width={250}
        height={250}
      />
...
/>
    ...
    title: "Tailwind CSS"  },
    {
      ...
      icon: (
        <Image
    src="/images/products/phongbi/phongbi2.png"  // Replace with the correct path to your SVG file
    alt="description of the image"
    width={250} 
    height={250}
  />
      ...
      title: "Tailwind CSS"  },
      {
        ...
        icon: (
          <Image
      src="/images/products/phongbi/phongbi3.png"  // Replace with the correct path to your SVG file
      alt="description of the image"
      width={250} 
      height={250}
    />
